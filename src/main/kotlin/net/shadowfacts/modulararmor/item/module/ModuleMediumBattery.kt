 ...
 * @author shadowfacts
 */
class ModuleMediumBattery: ItemModuleBase("medium_battery") {

	override fun createModule(): IModule {
		return MediumBattery()
	}

	class MediumBattery: ModuleBase(EnumSet.of(EntityEquipmentSlot.HEAD, EntityEquipmentSlot.CHEST, EntityEquipmentSlot.LEGS, EntityEquipmentSlot.FEET)) {

		val handler = EnergyHandler(5000)
